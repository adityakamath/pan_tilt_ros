...
public:
    PanTiltNode() : Node("omni_control_node")
    {
        ...
        vector<long int> min_step   = this->declare_parameter<vector<long int>>("min_pos", {1024, 1500});
        vector<long int> max_step   = this->declare_parameter<vector<long int>>("max_pos", {3072, 3072});
